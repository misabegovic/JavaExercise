...
@rem ##########################################################################
@rem
@rem  javaProject startup script for Windows
@rem
@rem ##########################################################################
...
set CLASSPATH=%APP_HOME%\lib\javaProject.jar;%APP_HOME%\lib\slf4j-api-1.7.13.jar

@rem Execute javaProject
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JAVA_PROJECT_OPTS%  -classpath "%CLASSPATH%" Main %CMD_LINE_ARGS%
